...
export const CollectionsPage: React.FC = () => {
  ...
  const signatureScents = products.filter((p) => p.featured || p.product_type === 'single');
  ...
  return (
    <div className="space-y-20 sm:space-y-28 pb-16">
      ...
      {loading ? (
        ...
        <div className="max-w-xl mx-auto py-16 text-center space-y-3 bg-white border border-[#E6E3DC] p-8">
          ...
          <button
            ...
            className="mt-2 px-6 py-2.5 bg-[#111111] text-white text-xs uppercase tracking-wider font-medium"
          >
            Retry
          </button>
        </div>
      ) : products.length === 0 ? (
        <div className="max-w-xl mx-auto py-16 text-center space-y-2 bg-white border border-[#E6E3DC] p-8">
          <p className="font-serif text-2xl text-[#111111]">No active products found</p>
          <p className="text-xs text-[#6B6B6B]">The collection is currently being updated.</p>
        </div>
      ) : (
        <>
