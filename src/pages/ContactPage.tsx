          ...
          <div className="space-y-4 text-xs">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a href="tel:+8801700000000" className="text-[#6B6B6B] hover:text-[#111111]">
                  +880 1700-000000
                </a>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a href="mailto:contact@aevyfragrance.com" className="text-[#6B6B6B] hover:text-[#111111]">
                  contact@aevyfragrance.com
                </a>
