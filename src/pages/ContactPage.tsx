          ...
          <div className="bg-[#111111] border border-[#2A2A2A] p-6 sm:p-8 space-y-6 shadow-xl">
            ...
            <div className="space-y-4 text-xs">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <span className="font-semibold text-[#F5F1E8] uppercase tracking-wider block text-[11px]">WhatsApp Concierge</span>
                  <p className="text-[#F5F1E8]/70 mt-0.5 font-light">
                    {settings.whatsappNumber || '+880 1712-345678'} (Daily 10:00 AM – 10:00 PM)
                  </p>
                  <a
                    href={`https://wa.me/${cleanPhone}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block mt-1 text-[#C8A96A] underline text-xs font-medium"
                  >
                    Open WhatsApp Chat →
                  </a>
                </div>
