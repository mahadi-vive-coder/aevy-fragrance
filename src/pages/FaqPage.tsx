    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 text-[#F5F1E8]">
      ...
      <div className="mt-14 p-6 sm:p-8 bg-[#111111] border border-[#2A2A2A] text-center space-y-3 shadow-xl">
        ...
        <p className="text-xs sm:text-sm text-[#D4CEBF] max-w-md mx-auto leading-relaxed">
          Our fragrance concierge is at your service 7 days a week for personalized olfactive advice, notes analysis, and delivery queries.
        </p>
        <div className="pt-2 flex flex-wrap justify-center gap-4">
          <a
            href="tel:01629927898"
            className="px-5 py-2.5 bg-[#C8A96A] text-[#0B0B0B] text-xs uppercase tracking-widest font-bold hover:bg-[#F5F1E8] transition-colors"
          >
            Call Concierge: 01629927898
          </a>
          <a
            href="mailto:concierge@aevyfragrance.com"
            className="px-5 py-2.5 bg-transparent border border-[#2A2A2A] text-[#FAFAF8] text-xs uppercase tracking-widest font-semibold hover:border-[#C8A96A] hover:text-[#C8A96A] transition-colors"
          >
            Email Concierge
          </a>
        </div>
