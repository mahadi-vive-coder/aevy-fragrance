...
export const HomePage: React.FC = () => {
  ...
  const signatureProducts = products.filter((p) => p.is_featured).slice(0, 4);
  ...
  const heroImage = heroProduct?.image_url || (heroProduct?.images && heroProduct?.images[0]) || 'https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?auto=format&fit=crop&w=800&q=85';
