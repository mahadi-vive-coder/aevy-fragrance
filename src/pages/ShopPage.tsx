  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-xs">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <option value="15ml">15ml (Travel Edition)</option>
                <option value="30ml">30ml (Signature Flacon)</option>
                <option value="50ml">50ml (Grand Edition)</option>
              </select>
            </div>
          </div>
        </div>
      ...
      {loading ? (
        ...
        <div className="py-20 text-center space-y-4 bg-white border border-[#E6E3DC] p-8 max-w-xl mx-auto">
        ...
        <div className="py-20 text-center space-y-4 bg-white border border-[#E6E3DC] p-8">
          ...
          <p className="text-xs text-[#6B6B6B] max-w-sm mx-auto">
            {products.length === 0
              ? 'No active products found in the collection.'
